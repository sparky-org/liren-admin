...
public class TaskControllerTest {
    ...
    @Test
    public void testPublishTask() throws ParseException {
        ...
        BaseResponseWrapper result = myTaskController.publishTask(dto);
        Assert.isTrue(result.isSuccess());
    }

    private PublishTaskDTO initPublishTaskDTO(ShopEmployee admin) {
        PublishTaskDTO taskDTO = new PublishTaskDTO();
        taskDTO.setTaskTitle("测试任务");
        taskDTO.setTaskDesc("测试任务内容");
