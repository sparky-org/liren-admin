...
public class ServiceRecordControllerTest {
    ...
    public void testCase2() {
        ...
        Assert.isTrue(wrapper1.isSuccess());
        //审批
        Long applyNo = ((List<ListApplyVO>)wrapper1.getResult()).get(0).getApplyNo();
        Long serviceRecordNo = ((List<ListApplyVO>)wrapper1.getResult()).get(0).getServiceItem().getServiceRecordNo();
        BaseResponseWrapper wrapper2 = myApplyController.approve(applyNo, true, admin.getId());
        Assert.isTrue(wrapper2.isSuccess());
        //查看业绩申请详情
        BaseResponseWrapper wrapper3 = serviceItemRecordController.getSalesPerfApply(serviceRecordNo);
        Assert.isTrue(wrapper3.isSuccess());
        System.out.println(JSONObject.toJSONString(wrapper3.getResult()));
    }
